...
class Ui_TRL(object):
    def setupUi(self, TRL):
        ...
        self.listWidget_thru = ListWidget(self.tab_calStandards)
        ...
        self.listWidget_reflect = ListWidget(self.tab_calStandards)
        ...
        self.listWidget_line = ListWidget(self.tab_calStandards)
        ...
        self.listWidget_measurements = ListWidget(self.tab_measurements)
        ...
        self.btn_saveMeasurement = QtWidgets.QPushButton(self.tab_measurements)
        self.btn_saveMeasurement.setObjectName("btn_saveMeasurement")
        self.horizontalLayout_12.addWidget(self.btn_saveMeasurement)
        self.btn_saveAllMeasurements = QtWidgets.QPushButton(self.tab_measurements)
        self.btn_saveAllMeasurements.setObjectName("btn_saveAllMeasurements")
        self.horizontalLayout_12.addWidget(self.btn_saveAllMeasurements)
        self.tab_measurements_layout.addLayout(self.horizontalLayout_12)
    ...
    def retranslateUi(self, TRL):
        ...
        TRL.setWindowTitle(_translate("TRL", "Form"))
        ...
        self.btn_saveMeasurement.setText(_translate("TRL", "Save Selected"))
...
from pyMultiCal.widgets import ListWidget
